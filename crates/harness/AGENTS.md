...
- **Prazo de transporte da bridge de Workers (`TOOL_CALL_TIMEOUT` = 900s) excede o teto de bloqueio da tool (`wait_for_status` = 600s)** com margem explícita de 300s (mínimo 60s) para round-trip de IPC, serialização JSON-RPC e scheduling.
