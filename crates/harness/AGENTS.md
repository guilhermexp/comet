...
- **Prazo de transporte da bridge de Workers (`TOOL_CALL_TIMEOUT` = 180s) excede o teto de bloqueio da tool (`wait_for_status` = 120s)** com margem explícita de 60s para round-trip de IPC, serialização JSON-RPC e scheduling.
