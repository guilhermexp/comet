...
- Write/Edit progressivos preservam input incremental como refresh de `ToolCall` com o mesmo id. O decoder parcial é limitado a 1 MiB e só extrai strings suportadas, sem tentar reparar JSON genérico nem inventar bytes.
