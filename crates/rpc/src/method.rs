...
rpc_methods! {
    ...
    GET_CHECKOUT_STATUS / GetCheckoutStatus = "GetCheckoutStatus" { params: zeron_proto::GetCheckoutStatusRequest, reply: zeron_proto::CheckoutStatus, forwardable: true },
    WATCH_CHECKOUT_STATUS / WatchCheckoutStatus = "WatchCheckoutStatus" { params: zeron_proto::WatchCheckoutStatusRequest, reply: zeron_proto::CheckoutStatus, forwardable: true, stream: true },
    ...
    SYNC_CHECKOUT / SyncCheckout = "SyncCheckout" { params: zeron_proto::CheckoutOpRequest, reply: serde_json::Value, forwardable: true, deadline_secs: 900 },
