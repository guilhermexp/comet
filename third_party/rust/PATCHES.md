...
The rtc-sctp archive omits the repository-root license files. `LICENSE-MIT` and `LICENSE-APACHE` are copied verbatim from webrtc-rs/rtc commit `69ebe02fb1ba8d4fd51cce76c579c68fafb6b04b`, recorded in the package `.cargo_vcs_info.json`.
