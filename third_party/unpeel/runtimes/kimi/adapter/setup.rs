use crate::app_paths::{app_hooks_root, unpeel_home};
...
pub(crate) fn kimi_hook_script_path() -> PathBuf {
    app_hooks_root().join("kimi-hook.sh")
}
...
pub(crate) const KIMI_MANAGED_HOOKS_START: &str = "# BEGIN COMET MANAGED KIMI HOOKS";
pub(crate) const KIMI_MANAGED_HOOKS_END: &str = "# END COMET MANAGED KIMI HOOKS";
const LEGACY_KIMI_MANAGED_HOOKS_START: &str = "# BEGIN UNPEEL MANAGED KIMI HOOKS";
const LEGACY_KIMI_MANAGED_HOOKS_END: &str = "# END UNPEEL MANAGED KIMI HOOKS";

pub(crate) fn kimi_hook_command(event: &str) -> String {
    format!("\"{}\" {event}", kimi_hook_script_path().display())
}
...
pub(crate) fn strip_kimi_marker_block(raw: &str) -> String {
    ...
    for line in raw.split_inclusive('\n') {
        match line.trim() {
            KIMI_MANAGED_HOOKS_START | LEGACY_KIMI_MANAGED_HOOKS_START => skipping = true,
            KIMI_MANAGED_HOOKS_END | LEGACY_KIMI_MANAGED_HOOKS_END => skipping = false,
