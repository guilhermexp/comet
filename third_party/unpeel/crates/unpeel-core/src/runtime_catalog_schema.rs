...
impl RuntimeCapability {
    fn descriptor_name(self) -> &'static str {
        match self {
            ...
            Self::Fork => "fork",
            Self::AppendSystemContext => "append_system_context",
...
"##
    ...
    fn adapter_free_metadata_rejects_every_adapter_owned_capability() {
        ...
        for capability in [
            ...
            RuntimeCapability::Fork,
            RuntimeCapability::AppendSystemContext,
    ...
    fn transcript_capability_and_adapter_file_must_agree() {
        ...
        transcript_only.descriptor.lifecycle.fallback = RuntimeLifecycleFallback::Output;
