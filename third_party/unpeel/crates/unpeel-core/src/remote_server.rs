...
//!
//! Security model (see `docs/feature/remote-control-server.md`):
...
const OUTPUT_PUMP_UPSTREAM_TIMEOUT_MS: u64 = 50;
const OUTPUT_PUMP_CLIENT_POLL_MS: u64 = 5;
...
const OUTPUT_POLL_SLEEP_MS: u64 = 20;
...
fn pump_session_output<S: ConnStream>(
    ...
    let (start_offset, first_chunk, continue_explicit_replay, rebased) = match plan.explicit_start {
        Some(from) => {
