...
const SESSION_CREATE_MAX_COLUMNS: u16 = 300;
const SESSION_CREATE_MAX_ROWS: u16 = 120;
...
pub enum ControllerPrincipal {
    ...
    PairedDevice { device_id: String, name: String },
...
fn resolve_host_create(
    ...
    let command = if let Some(preset_id) = preset_id {
    ...
    Ok(ResolvedHostCreate {
        ...
        initial_columns: request
            .initial_columns
            .unwrap_or(SESSION_CREATE_INITIAL_COLUMNS)
            .clamp(2, SESSION_CREATE_MAX_COLUMNS),
        initial_rows: request
            .initial_rows
            .unwrap_or(SESSION_CREATE_INITIAL_ROWS)
            .clamp(2, SESSION_CREATE_MAX_ROWS),
    })
}
...
fn create_session(
    ...
    let resolved = resolve_host_create(body, context)?;
...
fn upload_principal_key(principal: &ControllerPrincipal) -> String {
    ...
    let identity = match principal {
        ...
        ControllerPrincipal::OwnerTransport { transport, subject } => json!({
    ...
    fn create_uses_only_catalogued_worktree_and_rejects_folders() {
        ...
        assert_eq!(
            ...
            &[ResolvedHostCreate {
                ...
                initial_rows: SESSION_CREATE_INITIAL_ROWS,
            }]
        );
