...
public enum UnpeelRuntimeCapability: String, Equatable, Hashable, Sendable {
    ...
    case fork = "fork"
    case appendSystemContext = "append_system_context"
...
public enum UnpeelRuntimeCatalog {
    public static let runtimes: [UnpeelRuntimeMetadata] = [
        ...
        UnpeelRuntimeMetadata(
            ...
            capabilities: [.lifecycleHooks, .resume, .restartAgent, .mcpSessions, .mcpBrowser, .mcpComputer, .transcript, .fork, .appendSystemContext, .notifyWhenDone],
            usageStores: [
        ...
        UnpeelRuntimeMetadata(
            ...
            distrustStopsWhileOutputGrows: false,
            capabilities: [.lifecycleHooks, .resume, .restartAgent, .transcript, .appendSystemContext, .notifyWhenDone],
            usageStores: [
                UnpeelRuntimeUsageStore(
                    root: ".grok/sessions",
                    extensions: Set(["jsonl"]),
