...
public struct UnpeelToolIcon: Equatable, Hashable, Identifiable, Sendable, CaseIterable {
    ...
    public static func forRuntime(_ runtime: UnpeelRuntimeMetadata) -> UnpeelToolIcon {
        ...
        return UnpeelToolIcon(
            ...
            key: runtime.iconKey,
            label: runtime.label,
            svgSource: hasAuthoredSVG ? authoredSVG! : genericAgentSVG,
    ...
    private static let genericAgentSVG = ##"<svg width="16" height="16" viewBox="0 0 24 24" fill="#FFFFFF" xmlns="http://www.w3.org/2000/svg"><path d="M12 2l1.64 5.36L19 9l-5.36 1.64L12 16l-1.64-5.36L5 9l5.36-1.64L12 2Z"/><path d="M19 15l.82 2.18L22 18l-2.18.82L19 21l-.82-2.18L16 18l2.18-.82L19 15Z"/></svg>"##
}
