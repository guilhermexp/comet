...
///
/// All command rewriting, provider identity selection, forking, appended
/// context, and verified resume-failure markers live in unpeel-core runtime
/// adapters. Native deliberately fails closed when the bundled Host cannot
/// produce a plan; it never guesses a provider command locally.
enum ResumeCommand {
