...
struct RecentActivityView: View {
    ...
    private func feedRow(_ entry: ActivityLogEntry) -> some View {
        ...
        return RecentActivityRow(
            ...
            event: Self.kindLabel(entry.kind, age: Self.ageString(entry.date)),
    ...
    private var emptyState: some View {
        VStack(spacing: 10) {
            ...
            Text("Session starts, finishes, and input requests will appear here.")
                .font(.system(size: 11))
    ...
    static func kindLabel(_ kind: ActivityLogEntry.Kind, age: String) -> String {
