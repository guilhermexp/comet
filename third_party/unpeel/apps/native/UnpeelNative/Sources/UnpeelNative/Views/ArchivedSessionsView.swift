...
//  UnpeelNative
//
//  Project-scoped archived session library. Recent archived sessions can
//  remain in the five-row stopped preview; right-clicking a project opens
//  the complete main-pane library.
//
...
private struct ArchivedSessionCard: View {
    ...
    private var removeConfirmation: some View {
        HStack(spacing: 8) {
            Text("Delete session and history?")
                .font(.system(size: 11, weight: .medium))
                .foregroundStyle(Theme.foreground)
