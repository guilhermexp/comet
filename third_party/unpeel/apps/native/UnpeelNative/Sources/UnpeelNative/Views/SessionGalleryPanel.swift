...
struct SessionGalleryButton: View {
    ...
    var body: some View {
        HStack(spacing: 0) {
            Button {
                ...
                Image(systemName: "photo.on.rectangle")
                    ...
                    .background(hovering ? Theme.hoverRow.opacity(0.45) : .clear)
            ...
            Button {
                ...
                Image(systemName: "chevron.down")
                    ...
                    .background(chevronHovering ? Theme.hoverRow.opacity(0.45) : .clear)
                    .contentShape(Rectangle())
            }
            .buttonStyle(.plain)
        ...
        .modifier(GalleryChipBackground())
...
/// The same glass/material treatment WorkspaceOpenMenu uses for its chip.
