...
enum Snapshot {
    static func armIfRequested(
        ...
        // session plus the recent stopped window, so the old
        ...
        // UNPEEL_DEBUG_OPEN_PRESETS=1|detail|detail-off — open settings on
        // the Presets tab (detail variants tweak the initial route inside
        // PresetsSettingsPanel.applyDebugRoute).
