...
//
    ...
    extension AppTerminalView {
        ...
        override open func scrollWheel(with event: NSEvent) {
            ...
            let mouseCaptured = surface?.isMouseCaptured == true
            ...
            if !mouseCaptured {
                ...
                // Mouse-captured TUIs (Claude's virtual scroll) repaint via
                // the PTY roundtrip; open the render pump now so those
                // repaints present at display rate from the first wheel
                // event instead of waiting on coalesced wakeups.
