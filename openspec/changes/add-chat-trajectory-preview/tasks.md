...
| F3 | U4, U5 | §3 | F2 | in-progress | — | Complete GPUI Trajectory surface and one-per-Chat titlebar/right-pane lifecycle | artifact-driven |
| F4 | U6 | §4 | F3 | in-progress | — | Native evidence across live, legacy, privacy, degraded, responsive, and theme states; DOX closure | human-driven |
