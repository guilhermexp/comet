...
|---|---|---|---|---|---|---|---|
| F1 | U1, U2 | §1 | — | gaps_found | 630aa8e3716995abe40c3324a7092937042a84c9 | Typed contracts plus fail-open local store, capture, legacy projection, and deletion lifecycle | none — automated |
