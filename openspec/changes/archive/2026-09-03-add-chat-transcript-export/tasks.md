...
| F3 | C8-C9 | correção de review | F2 | passed | — | JSON usa a mesma projeção sanitizada dos outros formatos | human-driven |
...
- [x] C9 Atualizar DOX, rodar suite UI completa e concluir UAT das seis ações antes do archive. files: `crates/ui/AGENTS.md`. verify: `cargo test -p zeron-ui` + visual.
