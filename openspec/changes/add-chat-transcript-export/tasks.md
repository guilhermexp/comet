...
|---|---|---|---|---|---|---|---|
| F1 | C1-C4 | §1 | — | pending | — | Pure renderer: three formats + artifact index + filename | none — unit |
| F2 | C5-C7 | §2 | F1 | pending | — | Six actions live in the chat menu, end to end | human-driven |
