# antigravity-managed-usage Specification

## Purpose

Device-local discovery, in-memory OAuth token refresh, and quota monitoring for managed Antigravity subscriptions.
