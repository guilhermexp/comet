# composer-model-memory Specification

## Purpose
Preserve the last explicitly selected harness and provider-qualified model for new Chats without changing the independent configuration of existing Chats.
