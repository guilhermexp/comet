# composer-inline-rendering Specification

## Purpose

Visual inline decoration of Markdown constructs within the composer input without mutating the underlying prompt text.
